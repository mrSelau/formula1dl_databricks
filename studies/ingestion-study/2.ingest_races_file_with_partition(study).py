...
races_df = spark.read.csv(
    f"/mnt/{storage_account_name}/{origen_blob}/{file_name}.csv",
...
races_selected_df.write.parquet(f"/mnt/{storage_account_name}/{destiny_blob}/{file_name}", mode="overwrite", partitionBy= "race_year")
